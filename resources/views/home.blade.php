                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header border-0 pb-0 d-sm-flex d-block">
                                <div>
                                    <h4 class="card-title mb-1">Most Favorites Restaurant</h4>
                            ...
                            <div class="card-body tab-content pb-0">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-xl-4 col-xxl-6 col-sm-6 mb-5">
                                            <div class="media mb-4">
                                                <a href="ecom-product-detail.html"><img src="public/images/dish/pic5.jpg" style="width:100%;" class="rounded" alt=""/></a>
                                            </div>
                                            <div class="info">
                                        ...
                                        <div class="col-md-4 col-xl-4 col-xxl-6 col-sm-6 mb-5">
                                            <div class="media mb-4">
                                                <a href="ecom-product-detail.html"><img src="public/images/dish/pic4.jpg" style="width:100%;" class="rounded" alt=""/></a>
                                            </div>
                                            <div class="info">
                                        ...
                                        <div class="col-md-4 col-xl-4 col-xxl-6 col-sm-6 mb-5">
                                            <div class="media mb-4">
                                                <a href="ecom-product-detail.html"><img src="public/images/dish/pic3.jpg" style="width:100%;" class="rounded" alt=""/></a>
                                            </div>
                                            <div class="info">
                                ...
                                <div class="tab-pane fade" id="weekly1">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-xl-4 col-xxl-6 col-sm-6 mb-5">
                                            <div class="media mb-4">
                                                <a href="ecom-product-detail.html"><img src="public/images/dish/pic2.jpg" style="width:100%;" class="rounded" alt=""/></a>
                                            </div>
                                            <div class="info">
                    ...
                    <div class="col-md-12">
                        <div class="widget-carousel owl-carousel">
                            <div class="items">
                                <div class="bootstrap-media card p-4">
                                    <div class="media mb-4 align-items-center">
                                        <a href="ecom-product-detail.html"><img class="mr-3 img-fluid rounded-xl" width="94" src="public/images/dish/pic1.jpg" alt="DexignZone"></a>
                                        <div class="media-body">
                                    ...
                                    <div class="reviewer-box">
                                        <div class="media align-items-center">
                                            <img class="mr-3 img-fluid rounded" width="55" src="public/images/avatar/1.jpg" alt="DexignZone">
                                            <div class="media-body">
                            ...
                            <div class="items">
                                <div class="bootstrap-media card p-4">
                                    <div class="media mb-4 align-items-center">
                                        <a href="ecom-product-detail.html"><img class="mr-3 img-fluid rounded-xl" width="94" src="public/images/dish/pic2.jpg" alt="DexignZone"></a>
                                        <div class="media-body">
                                    ...
                                    <div class="reviewer-box">
                                        <div class="media align-items-center">
                                            <img class="mr-3 img-fluid rounded" width="55" src="public/images/avatar/2.jpg" alt="DexignZone">
                                            <div class="media-body">
                            ...
                            <div class="items">
                                <div class="bootstrap-media card p-4">
                                    <div class="media mb-4 align-items-center">
                                        <a href="ecom-product-detail.html"><img class="mr-3 img-fluid rounded-xl" width="94" src="public/images/dish/pic3.jpg" alt="DexignZone"></a>
                                        <div class="media-body">
                                            <h5 class="mt-0 mb-3"><a class="text-black" href="ecom-product-detail.html">Tuna soup spinach with himalaya salt</a></h5>
                                    ...
                                    <div class="reviewer-box">
                                        <div class="media align-items-center">
                                            <img class="mr-3 img-fluid rounded" width="55" src="public/images/avatar/3.jpg" alt="DexignZone">
                                            <div class="media-body">
                            ...
                            <div class="items">
                                <div class="bootstrap-media card p-4">
                                    <div class="media mb-4 align-items-center">
                                        <a href="ecom-product-detail.html"><img class="mr-3 img-fluid rounded-xl" width="94" src="public/images/dish/pic4.jpg" alt="DexignZone"></a>
                                        <div class="media-body">
                                    ...
                                    <div class="reviewer-box">
                                        <div class="media align-items-center">
                                            <img class="mr-3 img-fluid rounded" width="55" src="public/images/avatar/4.jpg" alt="DexignZone">
                                            <div class="media-body">
                            ...
                            <div class="items">
                                <div class="bootstrap-media card p-4">
                                    <div class="media mb-4 align-items-center">
                                        <a href="ecom-product-detail.html"><img class="mr-3 img-fluid rounded-xl" width="94" src="public/images/dish/pic5.jpg" alt="DexignZone"></a>
                                        <div class="media-body">
                                            <h5 class="mt-0 mb-3"><a class="text-black" href="ecom-product-detail.html">Tuna soup spinach with himalaya salt</a></h5>
                                            <small class="mb-0"><a class="text-primary" href="javascript:void(0);">PIZZA</a></small>
                                        </div>
                                    ...
                                    <div class="reviewer-box">
                                        <div class="media align-items-center">
                                            <img class="mr-3 img-fluid rounded" width="55" src="public/images/avatar/5.jpg" alt="DexignZone">
                                            <div class="media-body">
                                                <h4 class="mt-0 mb-1 text-white">Roberto Jr.</h4>
                                                <small class="mb-0 text-light">Head Marketing</small>
                                            </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example3" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img class="rounded-circle" width="35" src="public/images/profile/small/pic1.jpg" alt=""></td>
                                        <td>Tiger Nixon</td>
                                        <td>Architect</td>
                                        <td>Male</td>
                                        <td>M.COM., P.H.D.</td>
                                    ...
                                    <tr>
                                        <td><img class="rounded-circle" width="35" src="public/images/profile/small/pic2.jpg" alt=""></td>
                                    ...
                                    <tr>
                                        <td><img class="rounded-circle" width="35" src="public/images/profile/small/pic3.jpg" alt=""></td>
                                        <td>Ashton Cox</td>
                                    ...
                                    <tr>
                                        <td><img class="rounded-circle" width="35" src="public/images/profile/small/pic4.jpg" alt=""></td>
                                        <td>Cedric Kelly</td>
                                        <td>Developer</td>
                                        <td>Male</td>
                                        <td>B.COM., M.COM.</td>
                                    ...
                                    <tr>
                                        <td><img class="rounded-circle" width="35" src="public/images/profile/small/pic5.jpg" alt=""></td>
                                        <td>Airi Satou</td>
                                        <td>Accountant</td>
                                        <td>Female</td>
                                        <td>B.A, B.C.A</td>
                                    ...
                                    <tr>
                                        <td><img class="rounded-circle" width="35" src="public/images/profile/small/pic6.jpg" alt=""></td>
